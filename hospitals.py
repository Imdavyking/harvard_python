...
class Space():
        ...
        while maximum is None or count < maximum:
            ...
            for hospital in self.hospitals:
                for replacement in self.get_neighbors(*hospital):
                    ...
                    if best_neighbor_cost is None or cost < best_neighbors_cost:
    ...
    def random_restart(self,maximum=None,image_prefix=None,log=False):
        best_hospitals = None
        best_cost = None
        ...
        for i in range(maximum):
            ...
            if best_cost is None or cost < best_cost:
                ...
                if log:
                    print(f"Found better solution: cost ${best_cost}")
            else:
                if log:
    ...
    def output_image(self,filename):
        ...
        house = Image.open("assets/images/House.jpg").resize(
            (cell_size,cell_size)
        )
        hospital = Image.open("assets/images/Hospital.jpg").resize(
            (cell_size,cell_size)
        )
        ...
        for i in range(self.height):
            for j in range(self.width):
                ...
                if (i, j) in self.hospitals:
                    img.paste(hospital, rect[0])

        draw.rectangle(
            (0, self.height*cell_size, self.width * cell_size,
                       self.height * cell_size + cell_size + padding * 2),
                       "black")
